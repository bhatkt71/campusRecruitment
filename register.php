...
<body onload="Captcha1()">
    ...
    <div class='container' style="background-color: whitesmoke;">
        ...
        <div class='hr'> </div>
        <h4 style="text-align:center;font-weight: 600; color: #c60; font-size: 18px; margin-left: 30px">Fill Out The
        ...
        <form method="post" onsubmit="return ValidCaptcha1()">
            <table cellpadding="5" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><input type="text" name="mobile" placeholder="Mobile Number" required minlength="10"
                            maxlength="12" id='Number'> </td>
                </tr>
              ...
              ?>
                ...
                <tr>
                    ...
                    <td><textarea name="address" class='ta' placeholder="Your Address" style="height: 100px;"
                ...
                <tr>
                    ...
                    <td><textarea name="about" class='ta' placeholder="About Your Self " style="height: 160px;"
                            required></textarea> </td>
            ...
            <input type="submit" class='bt_sb' name="btn_sbmt" value="Register  " id='submit_address'
                onclick="return Validate()">
            <div style="text-align: center;font-size: 14px;">if you are already registred? <a href="login.php">Login
                    now</a>
            </div>
            <div class='hr'> </div>
